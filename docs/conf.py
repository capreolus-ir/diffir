...
assert os.path.exists(os.path.abspath("../diffir"))
...
release = get_version("../diffir/__init__.py")
...
github_url = "https://github.com/capreolus-ir/DiffIR"
...
# latex_documents = [(master_doc, "DiffIR.tex", "DiffIR Documentation", "", "manual")]
...
# man_pages = [(master_doc, "DiffIR", "DiffIR Documentation", [author], 1)]
...
texinfo_documents = [
    (master_doc, "DiffIR", "DiffIR Documentation", author, "", "One line description of project.", "Miscellaneous")
]
